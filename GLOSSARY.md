...
In `14_ccversion_trends.ipynb`, the metric value at version V is computed from **only the files marked with that exact version**. Early versions with one or two files swing wildly under this convention.
